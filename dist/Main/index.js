...
(function($PS) {
  ...
  var update = function (buf) {
      return function (hash) {
          return function () {
              return $foreign.updateImpl(buf, hash);
          };
      };
  };
  var digest = function (hash) {
      return function () {
          return $foreign.digestImpl(hash);
      };
  };
  var createHash = function (alg) {
      return function () {
          return $foreign.createHashImpl(alg);
      };
  };
...
(function(exports) {
  ...
  exports._pages = function(browser) {
    return function() {
...
(function($PS) {
  ...
  var Data_Function_Uncurried = $PS["Data.Function.Uncurried"];
  var wsEndpoint = Data_Function_Uncurried.runFn1($foreign["_wsEndpoint"]);
  ...
  var title = runPromiseAffE1($foreign["_title"]);
  ...
  var disconnect = Data_Function_Uncurried.runFn1($foreign["_disconnect"]);
  var connect = function (dictUnion) {
      return runPromiseAffE1($foreign["_connect"]);
  };
...
(function($PS) {
  ...
  var OutputStdout = (function () {
      function OutputStdout(value0) {
          this.value0 = value0;
      };
      OutputStdout.create = function (value0) {
          return new OutputStdout(value0);
      };
      return OutputStdout;
  })();
  var OutputFilePath = (function () {
      function OutputFilePath(value0) {
          this.value0 = value0;
      };
      OutputFilePath.create = function (value0) {
          return new OutputFilePath(value0);
      };
      return OutputFilePath;
  })();
  var InputStdin = (function () {
      function InputStdin() {

      };
      InputStdin.value = new InputStdin();
      return InputStdin;
  })();
  var InputFilePath = (function () {
      function InputFilePath(value0) {
          this.value0 = value0;
      };
      InputFilePath.create = function (value0) {
          return new InputFilePath(value0);
      };
      return InputFilePath;
  })();
  var unref = $foreign["_unref"];
  var sha256Digest = function (s) {
      return function __do() {
          var buf = Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(s)(Node_Encoding.UTF8.value)();
          return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Node_Crypto_Hash.createHash("sha512"))(Node_Crypto_Hash.update(buf)))(Node_Crypto_Hash.digest))(Node_Buffer_Class.toString(Node_Buffer.mutableBufferEffect)(Node_Encoding.Hex.value))();
      };
  };

  // 毎回同じファイルを
  var withCache = function (v) {
      return function (gen) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(sha256Digest(v.source)))(function (digest) {
              var ext = (function () {
                  if (v.outputExt instanceof SVG) {
                      return ".svg";
                  };
                  if (v.outputExt instanceof PNG) {
                      return ".png";
                  };
                  throw new Error("Failed pattern match at Main (line 253, column 13 - line 255, column 22): " + [ v.outputExt.constructor.name ]);
              })();
              var path = Node_Path.concat([ v.cacheDir, digest + ext ]);
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.exists(path))(function (v1) {
                  if (v1) {
                      return Node_FS_Aff.readFile(path);
                  };
                  return Control_Bind.bind(Effect_Aff.bindAff)(gen)(function (buf) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Monad.unlessM(Effect_Aff.monadAff)(Node_FS_Aff.exists(v.cacheDir))(Node_FS_Aff.mkdir(v.cacheDir)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Node_FS_Aff.writeFile(path)(buf))(function () {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(buf);
                          });
                      });
                  });
              });
  ...
  var parseInput = function (v) {
      if (v === "-") {
          return InputStdin.value;
      };
      return new InputFilePath(v);
  };
  var parseFormat = function (v) {
      if (v === "svg") {
          return SVG.value;
      };
      if (v === "png") {
      ...
      return Partial_Unsafe.unsafeCrashWith("??svg|png");
  };
  var mkLogger = Control_Applicative.pure(Effect.applicativeEffect)({
      info: function (dictMonadEffect) {
          var $53 = Control_Applicative.pure((dictMonadEffect.Monad0()).Applicative0());
          var $54 = Data_Function["const"](Data_Unit.unit);
          return function ($55) {
              return $53($54($55));
          };
      }
  });
  var mkConfig = function __do() {
      var homeDir = (function __do() {
          var v = Node_Process.lookupEnv("HOME")();
          if (v instanceof Data_Maybe.Just) {
              return v.value0;
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Effect_Exception["throw"]("No home directory?")();
          };
          throw new Error("Failed pattern match at Main (line 143, column 11 - line 145, column 48): " + [ v.constructor.name ]);
      })();
      var rootDir = Node_Path.concat([ homeDir, ".excalidraw-cli" ]);
      return {
          wsEndpointPath: Node_Path.concat([ rootDir, "wsendpoint" ]),
          cacheDir: Node_Path.concat([ rootDir, "cache" ])
      };
  };

  // puppeteerブラウザ起動して放置すれば勝手に走り続けるはず
  // forkして呼出すことを想定
  var mainHeadlessBrowser = function __do() {
      var config = mkConfig();
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.launch()({
          headless: true
      }))(function (browser) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Toppokki.wsEndpoint(browser)))(function (wsEndpoint) {
              var dir = Node_Path.dirname(config.wsEndpointPath);
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Monad.unlessM(Effect_Aff.monadAff)(Node_FS_Aff.exists(dir))(Node_FS_Aff.mkdir(dir)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(config.wsEndpointPath)(Data_Newtype.unwrap()(wsEndpoint)))(function () {
  ...
  var fork = function (dictUnion) {
      return $foreign["_fork"];
  };

  // foldM :: forall f m a b. Foldable f => Monad m => (b -> a -> m b) -> b -> f a -> m b
  var findM = function (dictFoldable) {
      return function (dictMonad) {
          return function (pred) {
              return Data_Foldable.foldM(dictFoldable)(dictMonad)(function (ma) {
                  return function (a) {
                      return Data_Maybe.maybe(Control_Bind.ifM(dictMonad.Bind1())(pred(a))(Control_Applicative.pure(dictMonad.Applicative0())(new Data_Maybe.Just(a)))(Control_Applicative.pure(dictMonad.Applicative0())(Data_Maybe.Nothing.value)))((function () {
  ...
  var disconnect = $foreign["_disconnect"];

  // ブラウザをlaunchした場合、disconnectしても
  // TODO: デバッグ起動対応
  // https://nodejs.org/api/child_process.html#optionsdetached
  var withBrowser = function (logger) {
      return function (config) {
          return function (action) {
              var waitForChild = function (i) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(500.0))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Applicative.when(Effect_Aff.applicativeAff)(i > 4)(Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("too long"))))(function () {
                          return Control_Bind.ifM(Effect_Aff.bindAff)(Node_FS_Aff.exists(config.wsEndpointPath))(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit))(waitForChild(i + 1 | 0));
                      });
                  });
              };
              var tryConnect = Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(Control_Bind.bind(Effect_Aff.bindAff)(Data_Functor.map(Effect_Aff.functorAff)(Data_Newtype.wrap())(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(config.wsEndpointPath)))(function (wsEndpoint) {
                  return Toppokki.connect()({
                      browserWSEndpoint: wsEndpoint
                  });
              }));
              return Control_Bind.bind(Effect_Aff.bindAff)(Control_Bind.bind(Effect_Aff.bindAff)(tryConnect)(function (v) {
                  if (v instanceof Data_Either.Left) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(logger.info(Effect_Aff.monadEffectAff)("restart chrome"))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Control_Monad.whenM(Effect_Aff.monadAff)(Node_FS_Aff.exists(config.wsEndpointPath))(Node_FS_Aff.unlink(config.wsEndpointPath)))(function () {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(fork()("?")([  ])({
                                  detached: true,
                                  stdio: "ignore",
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(waitForChild(0))(function () {
                                          return Control_Bind.bind(Effect_Aff.bindAff)(tryConnect)(function (v1) {
                                              if (v1 instanceof Data_Either.Left) {
                                                  return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("run failed"));
                                              };
                                              if (v1 instanceof Data_Either.Right) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(logger.info(Effect_Aff.monadEffectAff)("restarted"))(function () {
                                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value0);
                                                  });
                                              };
                                              throw new Error("Failed pattern match at Main (line 223, column 22 - line 228, column 17): " + [ v1.constructor.name ]);
                                          });
                                      });
                                  });
                              });
                  ...
                  if (v instanceof Data_Either.Right) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(logger.info(Effect_Aff.monadEffectAff)("chrome running"))(function () {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(v.value0);
                      });
                  };
                  throw new Error("Failed pattern match at Main (line 209, column 29 - line 231, column 13): " + [ v.constructor.name ]);
              }))(function (browser) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(action(browser))(function (a) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Toppokki.disconnect(browser)))(function () {
  ...
  var defaultCdnVer = "0.11.0";
  var optsParser = Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Data_Functor.map(Options_Applicative_Types.parserFunctor)(function (v) {
      return function (v1) {
          return function (v2) {
              return function (v3) {
                  return {
  ...
  })(Data_Functor.map(Options_Applicative_Types.parserFunctor)(parseInput)(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("input"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("i"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("PATH"))(Options_Applicative_Builder.help("Input excalidraw file. Specify '-' to input from terminal. Required."))))))))(Control_Alt.alt(Options_Applicative_Types.parserAlt)(Data_Functor.map(Options_Applicative_Types.parserFunctor)(OutputFilePath.create)(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("output"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("o"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("PATH"))(Options_Applicative_Builder.help("Output file. It should have either .svg or .png extension.")))))))(Data_Functor.map(Options_Applicative_Types.parserFunctor)(function ($58) {
      return OutputStdout.create(parseFormat($58));
  })(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("stdout"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("s"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("svg|png"))(Options_Applicative_Builder.help("Output format. It should be either svg or png.")))))))))(Options_Applicative_Builder.strOption(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("cdn-version"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("You can specify which version of @excalidraw/excalidraw to use. Will use official CDN."))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showString))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(defaultCdnVer))(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("VER"))))))))(Options_Applicative_Builder["switch"](Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.flagFieldsHasName)("debug"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("Show the browser and don't close it atomatically even after successfully created."))(Options_Applicative_Builder.showDefault(Data_Show.showBoolean)))));
  var optsInfo = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(optsParser)(Options_Applicative_Extra.helper))(Data_Semigroup.append(Options_Applicative_Builder.infoModSemigroup)(Options_Applicative_Builder.fullDesc)(Options_Applicative_Builder.header("excalidraw-cli - cli command for excalidraw")));
  var cdnUrl = function (ver) {
      return "https://unpkg.com/@excalidraw/excalidraw@" + (ver + "/dist/excalidraw.production.min.js");
  };
  var cdnReactUrl = "https://unpkg.com/react/umd/react.production.min.js";
  var cdnReactDomUrl = "https://unpkg.com/react-dom/umd/react.production.min.js";

  // | MermaidAPI を利用してSVGを得る。
  // | 一時的に画面には(hiddenな)DOMが追加されるが、最終的には何もない状態。
  // | ビューポートのサイズはレンダリングに影響を与えない。
  //
  var excalidrawRender = function (logger) {
      return function (browser) {
          return function (cdnVer) {
              return function (source) {
                  return function (outputExt) {
                      var title = "excalidraw-" + cdnVer;
                    
                      // Excalidraw.exportToSvg({..}) : Promise
                      // exportToSvgで得られるSVGは文字列形式ではなくDOM形式。
  var renderSvg = function (page) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.unsafeEvaluateWithArgs("\x0a          async (source) => {\x0a            const svg = await Excalidraw.exportToSvg(JSON.parse(source));\x0a            return (new XMLSerializer()).serializeToString(svg);\x0a          }\x0a        ")([ Foreign.unsafeToForeign(source) ])(page))(function (svg) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(Foreign.unsafeFromForeign(svg))(Node_Encoding.UTF8.value));
                          });
                      };
  ...
  var renderPng = function (page) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.unsafeEvaluateWithArgs("\x0a          async (source) => {\x0a            const blob = await Excalidraw.exportToBlob({...JSON.parse(source), mimeType: \"image/png\"});\x0a            const reader = new FileReader();\x0a            reader.readAsBinaryString(blob);\x0a            return await new Promise((resolve, reject) => reader.onload = () => resolve(reader.result));\x0a          }\x0a        ")([ Foreign.unsafeToForeign(source) ])(page))(function (binstr) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(Foreign.unsafeFromForeign(binstr))(Node_Encoding.Binary.value));
                          });
                      };
                      var indexHtml = (function () {
                          var template = Text_Smolder_HTML.html(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.head(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_HTML.title(Text_Smolder_Markup.text(title)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.script)(Text_Smolder_Markup.safe(Text_Smolder_HTML_Attributes.src(cdnReactUrl))))(Text_Smolder_HTML_Attributes["type'"]("text/javascript"))(Text_Smolder_Markup.text("")))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.script)(Text_Smolder_Markup.safe(Text_Smolder_HTML_Attributes.src(cdnReactDomUrl))))(Text_Smolder_HTML_Attributes["type'"]("text/javascript"))(Text_Smolder_Markup.text("")))(function () {
                                      return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupF)(Text_Smolder_HTML.script)(Text_Smolder_Markup.safe(Text_Smolder_HTML_Attributes.src(cdnUrl(cdnVer)))))(Text_Smolder_HTML_Attributes["type'"]("text/javascript"))(Text_Smolder_Markup.text(""));
                                  });
                              });
                          })))(function () {
                              return Text_Smolder_HTML.body(Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Unit.unit));
                          }));
                          return Text_Smolder_Renderer_String.render(template);
                      })();
                      var findOrCreatePage = Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.pages(browser))(function (pages) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(findM(Data_Foldable.foldableArray)(Effect_Aff.monadAff)(function (page) {
                              return Data_Functor.map(Effect_Aff.functorAff)(function (v) {
                                  return v === title;
                              })(Toppokki.title(page));
                          })(pages))(function (page$prime) {
                              if (page$prime instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(logger.info(Effect_Aff.monadEffectAff)("re-using page"))(function () {
                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(page$prime.value0);
                                  });
                              };
                              if (page$prime instanceof Data_Maybe.Nothing) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(logger.info(Effect_Aff.monadEffectAff)("new page"))(function () {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.newPage(browser))(function (page) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Toppokki.setContent(indexHtml)(page))(function () {
                                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(page);
                                          });
                                      });
                                  });
                              };
                              throw new Error("Failed pattern match at Main (line 286, column 5 - line 294, column 18): " + [ page$prime.constructor.name ]);
                          });
                      });
                      return Control_Bind.bind(Effect_Aff.bindAff)(findOrCreatePage)(function (page) {
                          if (outputExt instanceof SVG) {
                              return renderSvg(page);
                          };
                          if (outputExt instanceof PNG) {
                              return renderPng(page);
                          };
                          throw new Error("Failed pattern match at Main (line 279, column 3 - line 281, column 26): " + [ outputExt.constructor.name ]);
                      });
                  };
              };
          };
  ...
  var main = function __do() {
      ...
      var input = (function () {
          if (opts.input instanceof InputStdin) {
              return "/dev/stdin";
          };
          if (opts.input instanceof InputFilePath) {
              return opts.input.value0;
          };
          throw new Error("Failed pattern match at Main (line 170, column 10 - line 172, column 33): " + [ opts.input.constructor.name ]);
      })();
      var output = (function () {
          if (opts.output instanceof OutputStdout) {
              return "/dev/stdout";
          };
          if (opts.output instanceof OutputFilePath) {
              return opts.output.value0;
          };
          throw new Error("Failed pattern match at Main (line 174, column 10 - line 176, column 34): " + [ opts.output.constructor.name ]);
      })();
      var outputExt = (function () {
          ...
          if (opts.output instanceof OutputFilePath) {
              var v1 = Node_Path.extname(opts.output.value0);
              if (v1 === ".svg") {
                  return SVG.value;
              };
              if (v1 === ".png") {
          ...
          throw new Error("Failed pattern match at Main (line 177, column 16 - line 182, column 62): " + [ opts.output.constructor.name ]);
      })();
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(input))(function (source) {
          return Control_Bind.bind(Effect_Aff.bindAff)(withCache({
              cacheDir: v.cacheDir,
              source: source,
              outputExt: outputExt
          })(withBrowser(logger)(v)(function (browser) {
              return excalidrawRender(logger)(browser)(opts.cdnVer)(source)(outputExt);
          })))(function (buf) {
              return Node_FS_Aff.writeFile(output)(buf);
          });
      }))();
  };
  exports["main"] = main;
  exports["mainHeadlessBrowser"] = mainHeadlessBrowser;
})(PS);
