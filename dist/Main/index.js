...
(function($PS) {
  ...
  var mkConfig = function __do() {
      var homeDir = (function __do() {
          ...
          throw new Error("Failed pattern match at Main (line 139, column 11 - line 141, column 48): " + [ v.constructor.name ]);
      })();
              ...
              return Data_Foldable.foldM(dictFoldable)(dictMonad)(function (ma) {
                  return function (a) {
                      return Data_Maybe.maybe(Control_Bind.ifM(dictMonad.Bind1())(pred(a))(Control_Applicative.pure(dictMonad.Applicative0())(new Data_Maybe.Just(a)))(Control_Applicative.pure(dictMonad.Applicative0())(Data_Maybe.Nothing.value)))((function () {
                          var $40 = Control_Applicative.pure(dictMonad.Applicative0());
                          return function ($41) {
                              return $40(Data_Maybe.Just.create($41));
                          };
                      })())(ma);
                  };
  ...
  var withBrowser = function (config) {
      return function (action) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Control_Bind.bind(Effect_Aff.bindAff)(tryConnect)(function (v) {
              if (v instanceof Data_Either.Left) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("restart chrome"))(function () {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(waitForChild(0))(function () {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(tryConnect)(function (v1) {
                                          ...
                                          if (v1 instanceof Data_Either.Right) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("restarted"))(function () {
                                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1.value0);
                                              });
                                          };
                                          throw new Error("Failed pattern match at Main (line 211, column 22 - line 216, column 17): " + [ v1.constructor.name ]);
                                      });
                                  });
                              });
                          });
              ...
              if (v instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("chrome running"))(function () {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(v.value0);
                  });
              };
              throw new Error("Failed pattern match at Main (line 197, column 29 - line 219, column 13): " + [ v.constructor.name ]);
          }))(function (browser) {
  ...
  //
  var excalidrawRender = function (browser) {
  ...
  var renderPng = function (page) {
                  ...
                  var findOrCreatePage = Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.pages(browser))(function (pages) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(findM(Data_Foldable.foldableArray)(Effect_Aff.monadAff)(function (page) {
                          ...
                          if (page$prime instanceof Data_Maybe.Just) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("re-using page"))(function () {
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(page$prime.value0);
                              });
                          };
                          if (page$prime instanceof Data_Maybe.Nothing) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("new page"))(function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 248, column 5 - line 256, column 18): " + [ page$prime.constructor.name ]);
                      });
                  });
                  return Control_Bind.bind(Effect_Aff.bindAff)(findOrCreatePage)(function (page) {
                      ...
                      throw new Error("Failed pattern match at Main (line 241, column 3 - line 243, column 26): " + [ outputExt.constructor.name ]);
                  });
              };
          };
      };
  ...
  var main = function __do() {
      ...
      var input = (function () {
          ...
          throw new Error("Failed pattern match at Main (line 154, column 10 - line 156, column 33): " + [ opts.input.constructor.name ]);
      })();
      var output = (function () {
          ...
          throw new Error("Failed pattern match at Main (line 158, column 10 - line 160, column 34): " + [ opts.output.constructor.name ]);
      })();
      var outputExt = (function () {
          ...
          if (opts.output instanceof OutputFilePath) {
              var v = Node_Path.extname(opts.output.value0);
              if (v === ".svg") {
                  return SVG.value;
              };
              if (v === ".png") {
          ...
          throw new Error("Failed pattern match at Main (line 161, column 16 - line 166, column 62): " + [ opts.output.constructor.name ]);
      })();
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(input))(function (source) {
          return withBrowser(config)(function (browser) {
              return Control_Bind.bind(Effect_Aff.bindAff)(excalidrawRender(browser)(opts.cdnVer)(source)(outputExt))(function (buf) {
