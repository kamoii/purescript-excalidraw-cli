...
(function($PS) {
  ...
  var convertSvgToPng = function (browser) {
      return function (svg) {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.newPage(browser))(function (page) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.setContent(indexHtml)(page))(function () {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.unsafePageEval("svg")("\x0a      (svg) => {\x0a        const react = svg.getBoundingClientRect();\x0a        return { x: react.left, y: react.top, width: react.width, height: react.height }\x0a      }\x0a    ")(page))(function (clip$prime) {
                      return Toppokki.screenshot()({
                          clip: Foreign.unsafeFromForeign(clip$prime)
                      })(page);
                  });
              });
          });
          ...
          return function (source) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.newPage(browser))(function (page) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Toppokki.setContent(indexHtml)(page))(function () {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.unsafeEvaluateWithArgs("\x0a      (source) => {\x0a        return Excalidraw.exportToSvg(JSON.parse(source))\x0a          .then(function(svg) { return (new XMLSerializer()).serializeToString(svg)});\x0a      }\x0a    ")([ Foreign.unsafeToForeign(source) ])(page))(function (svg$prime) {
  ...
  var main = function __do() {
      ...
      var input = (function () {
          ...
          throw new Error("Failed pattern match at Main (line 125, column 10 - line 127, column 33): " + [ opts.input.constructor.name ]);
      })();
      var output = (function () {
          ...
          throw new Error("Failed pattern match at Main (line 129, column 10 - line 131, column 34): " + [ opts.output.constructor.name ]);
      })();
      var outputExt = (function () {
          ...
          throw new Error("Failed pattern match at Main (line 132, column 16 - line 137, column 62): " + [ opts.output.constructor.name ]);
      })();
      ...
      return Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(input))(function (source) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Toppokki.launch()({
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(excalidrawRender(browser)(opts.cdnVer)(source))(function (svg) {
                  return Control_Bind.bind(Effect_Aff.bindAff)((function () {
                      if (outputExt instanceof SVG) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Buffer_Class.fromString(Node_Buffer.mutableBufferEffect)(svg)(Node_Encoding.UTF8.value));
                      };
                      if (outputExt instanceof PNG) {
                          return convertSvgToPng(browser)(svg);
                      };
                      throw new Error("Failed pattern match at Main (line 144, column 12 - line 146, column 41): " + [ outputExt.constructor.name ]);
                  })())(function (buf) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Node_FS_Aff.writeFile(output)(buf))(function () {
